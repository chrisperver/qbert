...
checkdictionaryword:
  ...
  ld (iy+option21),b
  l9a15:
    call parsedictionaryword
    ret c
    call findnextdictionaryword ; FIND NEXT 0?
  jp l9a15
...
l9a1f:
  ...
  ;ld (l99c0),bc
  ld (iy+option20),dict_numbers MOD 256 ; c
  ld (iy+option21),dict_numbers / 256 ;b
jp l9a15
...
l9a2e:
  ...
  ;ld (l99c0),bc
  ld (iy+option20),dict_space MOD 256 ;c
  ld (iy+option21),dict_space / 256 ;b
jp l9a15
